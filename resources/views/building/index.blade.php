...
@section('content')
    <div class="panel panel-body">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">ชุดแบบสอบถาม</a></li>
        </ol>
    </div>
    <div class="panel panel-body">
        <div class="row">
            <div class="col-xs-5">
                <h4><span class="bg-danger rounded sq-28"><span class=" icon icon-institution"></span></span> อาคาร :
                    ชุดแบบสอบถาม</h4>
            </div>
                                    ...
                                    @if(isset($data->mains{0}))
                                        @if(($data->mains{0}->user_area == $area))
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('/building/process1/') }}/{{ $data->mains{0}->id }}/edit">{{ $data->mains{0}->code }}</a>
                                                </td>
                                                <th>
                                                    <a href="{{ url('/building/process1/') }}/{{ $data->mains{0}->id }}/edit">{{ $data->mains{0}->person_name }}</a>
                                                </th>
                                                <th>{{ $data->mains{0}->place_name }}</th>
                                                ...
                                                <td>
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            <li>
                                                                <a href="{{ url('/building/process1/') }}/{{ $data->mains{0}->id }}/edit">ดูเพิ่มเติม</a>
                                                            </li>
                                                            <li><a href="#"
                                                                   act="delete"
                                                                ...
                                                                >ลบ</a></li>
                                                            <li>
                                                                <a href="{{ url('/building/')}}/{{ $data->mains{0}->id }}/excel"
                                                                   act="export">Export to Excel</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                                {!! Form::close()!!}
...
@section('script')
    ...
    <script type="text/javascript" src="{{ asset('custom_assets/js/building/index.js')}}"></script>
